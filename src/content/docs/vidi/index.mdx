...
Som slutbruger skal du ikke installere noget – Vidi bruges i browseren på computer, tablet eller mobil. En serveroperatør skal først [installere og forbinde Vidi, GC2 og databasen](/gc2/installation-og-opstart).
...
![Vidi / GC2 arkitektur](./resources/index-vidi-GC2-arkitektur.svg)
...
Som almindelig bruger behøver du ikke bekymre dig om GC2 eller QGIS. Men hvis du skal administrere kort eller redigere data professionelt, vil du få adgang til disse værktøjer. Der kan du læse mere i [GC2-dokumentationen for administratorer](/gc2/).
