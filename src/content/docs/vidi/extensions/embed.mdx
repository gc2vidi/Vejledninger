...
:::note[Konfiguration i GC2]
  Meget af embed-oplevelsen styres via konfiguration. Hvis du arbejder med kørselskonfigurationer, templates og datagrundlag, kan du bruge [kørselskonfiguration i GC2 →](/gc2/koerselskonfiguration/oversigt), [print og templates →](/gc2/koerselskonfiguration/print-og-templates) og [lagmetadata →](/gc2/lag/felter-metadata-og-filtre) som indgang til den tekniske opsætning.
:::
...
<iframe
  src={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/embed-demo.html`}
