...
:::note[Konfiguration i GC2]
  Meget af embed-oplevelsen styres via konfiguration. Brug [Vidi-konfigurationer i GC2 →](/gc2/konfigurationer), [opret og udgiv →](/gc2/konfigurationer/opret-udgiv-og-test) og [Meta →](/gc2/skemaindstillinger/database/meta) som indgang til den tekniske opsætning.
:::
