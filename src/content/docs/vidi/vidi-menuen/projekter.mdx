...
[Læs mere om konfiguration, templates og embed i GC2 →](/gc2/koerselskonfiguration/print-og-templates)

Hvis du arbejder som administrator med projekter, tokens og delte links, er det også relevant at kende [kørselskonfiguration i GC2 →](/gc2/koerselskonfiguration/oversigt).
