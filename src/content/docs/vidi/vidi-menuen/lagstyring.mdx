...
:::note[Konfiguration]
Afkrydsningsfeltet ved laggruppen styres i Vidi-konfigurationen. Kontakt din administrator, hvis det skal tilføjes til jeres opsætning.

[Læs mere om data og lag i Vidi-konfigurationen →](/gc2/konfigurationer/data-lag-og-baggrundskort)
:::
...
- **Udvidet metadata:** Beskrivelse og ekstra information til brugeren

[Læs mere om Meta og laginformation i GC2 →](/gc2/skemaindstillinger/database/meta)
:::
...
[Læs mere om tabelstruktur og felter i GC2 →](/gc2/skemaindstillinger/database/tabelstruktur-data-og-felter).
:::
...
[Læs mere om filterkonfiguration i GC2 →](/gc2/skemaindstillinger/database/meta)
:::
