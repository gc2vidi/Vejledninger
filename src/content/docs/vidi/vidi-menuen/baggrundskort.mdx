...
![Vidi-menuen - baggrundskort](../resources/vidi-menu-baggrundskort.svg)
*Vidi-menuen - baggrundskort*
...
:::note[Konfiguration]
Baggrundskort vælges i den Vidi-konfiguration, som administreres i GC2.

[Læs mere om data, lag og baggrundskort i GC2 →](/gc2/konfigurationer/data-lag-og-baggrundskort)
:::
