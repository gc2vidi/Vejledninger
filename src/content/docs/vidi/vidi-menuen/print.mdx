...
![Vidi-menuen - print](../resources/vidi-menu-print.svg)
*Vidi-menuen - print*
...
:::note[Konfiguration]
Tilgængelige printdefinitioner vælges af systemadministratoren i Vidi-konfigurationen.

[Læs mere om printopsætning for administratorer →](/gc2/konfigurationer/soegning-funktioner-og-udseende)
:::
