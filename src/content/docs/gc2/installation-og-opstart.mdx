...
Fortsæt med [Log ind og dashboard](/gc2/log-ind-og-dashboard) og [Opret, importer og organiser lag](/gc2/skemaindstillinger/database/opret-importer-og-organiser-lag).
...
5. Begræns GC2-dashboard og `/install` yderligere, hvis organisationens sikkerhedsmodel kræver det.
...
- [Log ind og dashboard](/gc2/log-ind-og-dashboard)
